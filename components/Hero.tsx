...
/**
 * Hero Section Component - REDISEÑADO
 * Estilo moderno Notion/Linear con screenshot del producto
 */
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#solution" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                Características
              </a>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 pb-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 text-blue-700 text-sm font-medium mb-8 animate-fade-in">
            ...
            +15 plantillas profesionales listas para usar
          </div>

          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 tracking-tight leading-[1.1]">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto">
            Crea recibos, cotizaciones, facturas y más con plantillas inteligentes. 
            Solo llena las variables y descarga tu PDF.
          </p>
        ...
        <div className="relative max-w-5xl mx-auto">
          {/* Glow effect */}
          <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/20 via-blue-400/20 to-blue-600/20 rounded-2xl blur-2xl opacity-60"></div>
          
          {/* Screenshot container */}
          <div className="relative rounded-xl overflow-hidden shadow-2xl border border-gray-200 bg-white">
            <Image
              src="/screenshots/dashboard.png"
              alt="Dashboard de GeneraDocs"
              width={1920}
              height={1080}
          ...
          <div className="absolute -left-4 top-1/4 hidden lg:block">
            <div className="bg-white rounded-lg shadow-lg border border-gray-100 px-4 py-3 animate-float">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">PDF generado</span>
              </div>
            </div>
          </div>

          <div className="absolute -right-4 top-1/3 hidden lg:block">
            <div className="bg-white rounded-lg shadow-lg border border-gray-100 px-4 py-3 animate-float-delayed">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">Variables automáticas</span>
              </div>
            </div>
          </div>
        </div>
